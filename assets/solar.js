...
(() => {
  ...
  $$('.character-page .gallery img, .character-page .zoom img, .character-page .fullconcept img, .character-page .shot img, .character-page .canonical-hero img, .fleet-art img, .cast-banner img').forEach(img => {
